...
class Params:
    ...
    def __init__(self, ex_index=1, corpus_type='baidu'):
        ...
        self.bert_model_dir = self.root_path / 'pretrain_models/bert_base_cased' if corpus_type != 'baidu' else self.root_path / 'pretrain_models/bert_base_chinese'
        ...
        self.run_name = "{}+{}+{}".format("PRGC", corpus_type, self.train_batch_size) + ""
