...
def process():
    ...
    corpus_type = ['baidu']
    import os
    os.chdir('/home/hjj/code/RelationExtract/Joint_Extraction/PRGC/data')
    now_path = '/home/hjj/code/RelationExtract/Joint_Extraction/PRGC/data'
    for t in corpus_type:
        ...
        for typ in patterns.keys():
            with open(f'{now_path}/{t}/{typ}_triples.json', 'w', encoding='utf-8') as f:
        ...
        for key, values in num_dict.items():
            with open(f'{now_path}/{t}/{key}_triples.json', 'w', encoding='utf-8') as f:
